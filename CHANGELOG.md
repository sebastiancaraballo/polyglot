...
- Settings screen with a "Delete all app data" action that wipes the local database (all profiles, progress, and stats) behind an explicit confirmation defaulting to Cancel, then resets to onboarding.
